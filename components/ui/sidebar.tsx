...
import { PanelLeft, Twitter } from "lucide-react"
  ...
  return (
    <div className="w-64 border-r border-[#38444d] p-4 flex flex-col">
      ...
      {(orgLoading || clientsLoading) ? (
        <div className="text-[#8899a6] py-4">Loading clients...</div>
      ) : clients.length === 0 ? (
        <div className="text-[#8899a6] py-4">No clients found.</div>
      ) : (
        <div className="mb-8">
          <h3 className="text-lg font-medium text-[#8899a6] mb-4">
            {organization?.name || 'Your Clients'}
          </h3>
              ...
              <div 
                ...
                className={`px-3 py-2 rounded-md cursor-pointer transition-colors ${
                  selectedClientId === client.client_id 
                    ? 'bg-[#192734] text-[#1d9bf0]' 
                    : 'text-white hover:bg-[#192734]'
                }`}
              >
